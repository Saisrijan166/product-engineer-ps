...
public class MdcRequestFilter extends OncePerRequestFilter {
    ...
    private static final String RESOURCE_ID = "deliveryId";

    /** Matches {@code .../deliveries/{id}}, which is where both read endpoints carry theirs. */
    private static final String SEGMENT = "/deliveries/";
